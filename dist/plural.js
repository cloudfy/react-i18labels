 ...
 *   - Exact values:    "=0" | "=1" | "=42"
 */
export function pluralFn(value, locale, offset, ...cases) {
    ...
    if (exact !== undefined)
        return exact.replace(/#/g, display);
    ...
    if (byCategory !== undefined)
        return byCategory.replace(/#/g, display);
 ...
 */
const ordinalRulesCache = new Map();
export function ordinalFn(value, locale, offset, ...cases) {
